...
if len(sys.argv) != 2:
	sys.exit("Use: python remove_words_rad_impression.py <dataset>")
...
#read test set
test_list = open("./two/Impression/Test/test.txt",'r')
...
np.save('./Impression/text_gcn/validation.label', validation_label)

clean_corpus_str_validation = '\n'.join(clean_docs_validation) #use \n to connect each document.

#save cleaned corpus to file
f = open('./Impression/text_gcn/validation.clean.txt', 'w')
...
np.save('./Impression/text_gcn/test.label', test_label)

clean_corpus_str_test = '\n'.join(clean_docs_test) #use \n to connect each document.

#save cleaned corpus to file
f = open('./Impression/text_gcn/test.clean.txt', 'w')
