...
def main():
    ...
    np.save(output_path + 'impression/' + 'paragraphvec_impression_vs' + str(vector_size) + '_epoch' + str(epcoh) + '.npy', prob_predict)
    ...
    #Save trained model:
    output_svm_model_path = output_path + 'impression/' + 'svm_impression_model' + str(vector_size) + '_epoch' + str(epcoh) + '.pkl'
