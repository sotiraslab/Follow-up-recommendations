...
def main():
    ...
    # Example usage - replace these with your actual datasets
    # Format: List of (text, label) tuples or just list of texts
    train_texts = [
        ("first document about machine learning", "doc1"),
        ("second document about natural language processing", "doc2"),
    ...
    #read train set
    train_list = open("./Impression/Train/train.txt",'r')
    print(train_list)   
    train_texts = []
    train_label = []
    ...
    validation_list = open("./Impression/Validation/validation.txt",'r')
    ...
    test_list = open("./Impression/Test/test.txt",'r')
    print(test_list)   
    test_texts = []
    test_label = []
    ...
    np.save(output_path + 'impression2/' + 'paragraphvec_impression_vs' + str(vector_size) + '_epoch' + str(epcoh) + '.npy', prob_predict)
    ...
    #Save trained model:
    output_svm_model_path = output_path + 'impression2/' + 'svm_impression_model' + str(vector_size) + '_epoch' + str(epcoh) + '.pkl'
